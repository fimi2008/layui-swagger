package io.github.fimi2008.swagger.config;
...
public class SwaggerConfig {
    ...
    String description;
    @Value("${swagger.contact.name:wangxiang}")
    String contactName;
    @Value("${swagger.contact.url:fimi2008.github.io}")
    String contactUrl;
    @Value("${swagger.contact.mail:vonshine15@163.com}")
    String contactMail;
